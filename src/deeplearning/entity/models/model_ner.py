    ...
    def from_config(cls, config):
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                ...
                cls.__name__,
                ", ".join(
                    c.__name__ for c in MODEL_FOR_SOFTMAX_NER_MAPPING.keys()
                ),
            )
        )
    ...
    def from_config(cls, config):
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                ...
                cls.__name__,
                ", ".join(
                    c.__name__ for c in MODEL_FOR_CRF_NER_MAPPING.keys()
                ),
            )
        )
    ...
    def from_config(cls, config):
        ...
        raise ValueError(
            ...
            "Model type should be one of {}.".format(
                ...
                cls.__name__,
                ", ".join(
                    c.__name__ for c in MODEL_FOR_SPAN_NER_MAPPING.keys()
                ),
            )
        )
