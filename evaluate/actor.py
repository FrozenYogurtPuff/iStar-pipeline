...
from src.rules.entity.actor_plugins.include import dative_propn, xcomp_ask
from src.rules.entity.actor_plugins.include import relcl_who, tag as actor_tag, \
    dep as actor_dep, be_nsubj, ner as actor_ner, word_list as actor_word_list, \
    by_sb
